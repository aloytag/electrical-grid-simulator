...
class Settings_Dialog:
    ...
    def exec(self):
        ...
        load.const_z_p_percent.setValue(float(settings['const_z_p_percent']))
        load.const_i_p_percent.setValue(float(settings['const_i_p_percent']))
        load.const_z_q_percent.setValue(float(settings['const_z_q_percent']))
        load.const_i_q_percent.setValue(float(settings['const_i_q_percent']))
        ...
        if self.dialog.exec():
            ...
            self.config['load']['const_z_p_percent'] = str(load.const_z_p_percent.value())
            self.config['load']['const_i_p_percent'] = str(load.const_i_p_percent.value())
            self.config['load']['const_z_q_percent'] = str(load.const_z_q_percent.value())
            self.config['load']['const_i_q_percent'] = str(load.const_i_q_percent.value())
