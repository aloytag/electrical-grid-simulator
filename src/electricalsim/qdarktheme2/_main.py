...
from qdarktheme2._style_loader import load_palette, load_stylesheet
...
def _apply_style(app, additional_qss: str | None, **kargs) -> None:
    from qdarktheme2._proxy_style import QDarkThemeStyle
...
def _sync_theme_with_system(app, callback) -> None:
    from qdarktheme2._os_appearance import listener
...
def enable_hi_dpi() -> None:
    ...
    """
    from qdarktheme2.qtpy.QtCore import Qt
    from qdarktheme2.qtpy.QtGui import QGuiApplication
    ...
    *,
    ...
    Examples:
        ...
        1. Setup style and sync to system theme ::
            ...
            app = QApplication([])
            qdarktheme2.setup_theme()

        2. Use Dark Theme ::

            app = QApplication([])
            qdarktheme2.setup_theme("dark")

        3. Sharp corner ::

            # Change corner shape to sharp.
            app = QApplication([])
            qdarktheme2.setup_theme(corner_shape="sharp")

        4. Customize color ::

            app = QApplication([])
            qdarktheme2.setup_theme(custom_colors={"primary": "#D0BCFF"})
