"""Utility methods for qdarktheme2."""
...
def get_cash_root_path(version: str) -> Path:
    ...
    return Path.home() / ".cache" / "qdarktheme2" / f"v{version}"


def get_qdarktheme_root_path() -> Path:
    """Return the qdarktheme2 package root path.

    Returns:
        qdarktheme2 package root path.
    """
    return Path(inspect.getfile(qdarktheme2)).parent
