...
from NodeGraphQt6.base.commands import (NodeAddedCmd,
                                       NodesRemovedCmd,
                                       NodeMovedCmd,
                                       PortConnectedCmd)
from NodeGraphQt6.base.factory import NodeFactory
from NodeGraphQt6.base.menu import NodeGraphMenu, NodesMenu
from NodeGraphQt6.base.model import NodeGraphModel
from NodeGraphQt6.base.node import NodeObject
from NodeGraphQt6.base.port import Port
from NodeGraphQt6.constants import (
    URI_SCHEME,
    URN_SCHEME,
    LayoutDirectionEnum,
    PipeLayoutEnum,
...
from NodeGraphQt6.errors import NodeCreationError, NodeDeletionError
from NodeGraphQt6.nodes.backdrop_node import BackdropNode
from NodeGraphQt6.nodes.base_node import BaseNode
from NodeGraphQt6.nodes.group_node import GroupNode
from NodeGraphQt6.nodes.port_node import PortInputNode, PortOutputNode
from NodeGraphQt6.widgets.node_graph import NodeGraphWidget, SubGraphWidget
from NodeGraphQt6.widgets.viewer import NodeViewer
from NodeGraphQt6.widgets.viewer_nav import NodeNavigationWidget
...
class NodeGraph(QtCore.QObject):
    ...
    .. inheritance-diagram:: NodeGraphQt6.NodeGraph
    ...
    :parameters: list[:class:`NodeGraphQt6.NodeObject`]
    ...
    :parameters: :class:`NodeGraphQt6.NodeObject`
    :emits: created node
    """
    ...
    :parameters: list[:class:`NodeGraphQt6.NodeObject`],
                 list[:class:`NodeGraphQt6.NodeObject`]
    ...
    :parameters: :class:`NodeGraphQt6.Port`, :class:`NodeGraphQt6.Port`
    ...
    :parameters: :class:`NodeGraphQt6.BaseNode`, str, object
    ...
    :parameters: 
        :class:`NodeGraphQt6.NodeGraphMenu` or :class:`NodeGraphQt6.NodesMenu`, 
        :class:`NodeGraphQt6.BaseNode`
    ...
    def _on_insert_node(self, pipe, node_id, prev_node_pos):
        ...
        self._on_nodes_moved({n.id: pos for n, pos in prev_node_pos.items()})
    ...
    def model(self):
        ...
        Returns:
            NodeGraphQt6.base.model.NodeGraphModel: node graph model.
        """
        return self._model
    ...
    def viewer(self):
        ...
        Warnings:
            ...
            by ``NodeGraphQt6`` components to get the widget use
        ...
        Returns:
            NodeGraphQt6.widgets.viewer.NodeViewer: viewer interface.
        """
        return self._viewer
    ...
    def scene(self):
        ...
        Returns:
            NodeGraphQt6.widgets.scene.NodeScene: node scene.
        """
    ...
    def set_grid_mode(self, mode=None):
        ...
        (default: :attr:`NodeGraphQt6.constants.ViewerEnum.GRID_DISPLAY_LINES`).

        See: :attr:`NodeGraphQt6.constants.ViewerEnum`
    ...
    def add_properties_bin(self, prop_bin):
        ...
        Args:
            prop_bin (NodeGraphQt6.PropertiesBinWidget): properties widget.
        """
    ...
    def context_menu(self):
        ...
        Returns:
            NodeGraphQt6.NodeGraphMenu: context menu object.
        """
    ...
    def context_nodes_menu(self):
        ...
        Returns:
            NodeGraphQt6.NodesMenu: context menu object.
        """
    ...
    def get_context_menu(self, menu):
        ...
        Returns:
            NodeGraphQt6.NodeGraphMenu or NodeGraphQt6.NodesMenu: context menu object.
        """
    ...
    def _deserialize_context_menu(self, menu, menu_data):
        ...
        Args:
            menu (NodeGraphQt6.NodeGraphMenu or NodeGraphQt6.NodesMenu):
                parent context menu.
                    ...
                    'items': [
                        {
                            ...
                            'function': 'run_test',
                            'node_type': 'NodeGraphQt6.nodes.MyNodeClass'
                        },
    ...
    def pipe_style(self):
        ...
        Returns:
            int: pipe style value. :attr:`NodeGraphQt6.constants.PipeLayoutEnum`
        """
    ...
    def set_pipe_style(self, style=PipeLayoutEnum.CURVED.value):
        ...
        See: :attr:`NodeGraphQt6.constants.PipeLayoutEnum`
    ...
    def set_layout_direction(self, direction):
        ...
        **Layout Types:**
        ...
        - :attr:`NodeGraphQt6.constants.LayoutDirectionEnum.HORIZONTAL`
        - :attr:`NodeGraphQt6.constants.LayoutDirectionEnum.VERTICAL`
    ...
    def center_on(self, nodes=None):
        ...
        Args:
            nodes (list[NodeGraphQt6.BaseNode]): a list of nodes.
        """
        nodes = nodes or []
    ...
    def add_node(self, node, pos=None, selected=True, push_undo=True):
        ...
        Args:
            node (NodeGraphQt6.BaseNode): node object.
    ...
    def all_nodes(self):
        ...
        Returns:
            list[NodeGraphQt6.BaseNode]: list of nodes.
        """
    ...
    def get_node_by_id(self, node_id=None):
        ...
        Returns:
            NodeGraphQt6.NodeObject: node object.
        """
    ...
    def get_nodes_by_type(self, node_type):
        ...
        (see: :attr:`NodeGraphQt6.NodeObject.type_`)

        Args:
            node_type (str): node type identifier.

        Returns:
            list[NodeGraphQt6.NodeObject]: list of nodes.
        """
    ...
    def copy_nodes(self, nodes=None):
        ...
        Args:
            nodes (list[NodeGraphQt6.BaseNode]):
    ...
    def paste_nodes(self):
        ...
        Returns:
            list[NodeGraphQt6.BaseNode]: list of pasted node instances.
        """
        clipboard = QtWidgets.QApplication.clipboard()
    ...
    def _update_node_rank(node, nodes_rank, down_stream=True):
        ...
        Args:
            node (NodeGraphQt6.BaseNode): node to start from.
    ...
    def _compute_node_rank(nodes, down_stream=True):
        ...
        Args:
            nodes (list[NodeGraphQt6.BaseNode]): nodes to start ranking from.
            down_stream (bool): true to compute down stream.

        Returns:
            dict: {NodeGraphQt6.BaseNode: node_rank, ...}
        """
        nodes_rank = {}
        for node in nodes:
            nodes_rank[node] = 0
    ...
    def auto_layout_nodes(self, nodes=None, down_stream=True, start_nodes=None):
        ...
        Args:
            nodes (list[NodeGraphQt6.BaseNode]): list of nodes to auto layout
                if nodes is None then all nodes is layed out.
            down_stream (bool): false to layout up stream.
            start_nodes (list[NodeGraphQt6.BaseNode]):
    ...
    def expand_group_node(self, node):
        ...
        Args:
            node (NodeGraphQt6.GroupNode): group node.
...
class SubGraph(NodeGraph):
    ...
    :class:`NodeGraphQt6.GroupNode`.

    .. inheritance-diagram:: NodeGraphQt6.SubGraph
        :top-classes: PySide6.QtCore.QObject
    ...
    def _clone_context_menu_from_parent(self):
        ...
        def clone_menu(menu, menu_to_clone):
            """
            Args:
                menu (NodeGraphQt6.NodeGraphMenu):
                menu_to_clone (NodeGraphQt6.NodeGraphMenu):
            """
            sub_items = []
    ...
    def initialized_graphs(self):
        ...
        Returns:
            list[NodeGraphQt6.SubGraph]: list of sub graph objects.
        """
        if self._parent_graph.is_root:
    ...
    def parent_graph(self):
        ...
        Returns:
            NodeGraphQt6.NodeGraph or NodeGraphQt6.SubGraph: parent graph.
        """
    ...
    def node(self):
        ...
        Returns:
            NodeGraphQt6.GroupNode: group node.
        """
        return self._node
    ...
    def get_input_port_nodes(self):
        ...
        Returns:
            list[NodeGraphQt6.PortInputNode]: input nodes.
        """
    ...
    def get_output_port_nodes(self):
        ...
        Returns:
            list[NodeGraphQt6.PortOutputNode]: output nodes.
        """
    ...
    def get_node_by_port(self, port):
        ...
        Args:
            port (NodeGraphQt6.Port): parent node port object.
